...
## The solution code for manipulating DOM is given in respective assignment folder in a **README.md** file.

### For the **first, second, and third** assignment solution, the solution is in the **README.md** file present inside the **"DOM_Assignment_2.0-1-2-3"** folder.

[README.md file for assignment 1, 2, and 3](./DOM_Assignment_2.0-1-2-3/README.md)

------------------------------------------------

### For the **fourth** assignment- **"04_DOM_Project"** folder.

[README.md file for assignment 4](./04_DOM_Project/README.md)
